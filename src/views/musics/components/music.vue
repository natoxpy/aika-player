...
<template>
  <MusicTemplate>
    <template #cover>
      <div class="w-full h-full bg-cover bg-center" :style="{ backgroundImage: `url('${cover}')` }" />
    </template>
    <template #over-cover>
      <div
        ...
        <div>
          <button class="p-1 rounded-primary bg-[hsl(240,4%,16%,0.6)] hover:bg-[hsl(240,4%,16%,0.8)] transition-all"
            v-on:click="play">
