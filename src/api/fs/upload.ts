...
export async function uploadFromArrayBuffer(arrayBuffer: ArrayBuffer): Promise<File> {
    const res = await axios.post(`${API_LOCATION}/fs/upload`, new Blob([arrayBuffer]))
