...
<template>
  <div class="h-full border-baccent border-r flex flex-col relative overflow-y-auto">
    <Section>
      ...
      <template #options>
        <Option href="/" icon="circlePlay" :active="routeName == 'ListenNow'"> Listen Now </Option>
        <Option href="/browse" icon="layoutGrid" :active="routeName == 'Browse'"> Browse </Option>
      </template>
    </Section>
    ...
    <Section>
      ...
      <template #options>
        ...
        <Option href="/musics" icon="music" :active="routeName == 'Musics'"> Musics </Option>
        <Option href="/albums" icon="library" :active="routeName == 'Albums'"> Albums </Option>
        <Option href="/artists" icon="mic" :active="routeName == 'Artists'"> Artists </Option>
      </template>
    </Section>
